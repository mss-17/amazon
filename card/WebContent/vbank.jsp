          ...
          <header id="header">
			...
			<h1 align="center"><font color="Dark Blue"><b>One India Card</b></font></h1>
				...
				<nav id="nav">
					...
					<div class="nav-drop">
						<ul>
					<li><a href="addb.jsp"><h4 style="color:yellow">Add Bank</h4></a></li>
					<li><a href="vbank.jsp"><h4 style="color:yellow">View Banks</h4></a></li>
					<li><a href="vu.jsp"><h4 style="color:yellow">View Users</h4></a></li>
					<li><a href="crtt.jsp"><h4 style="color:yellow">credit transactions</h4></a></li>
					<li><a href="dbtt.jsp"><h4 style="color:yellow">debit transactions</h4></a></li>
	...
	%>		
						...
						<div class="row">
							...
							<div class="cell" data-title="Location">
								 ...
								 <a href="edit1.jsp?id=<%=rs.getString("id") %>&t1=<%=rs.getString("name") %>
								 &t2=<%=rs.getString("bid") %>&t3=<%=rs.getString("pass") %>
								 &t4=<%=rs.getString("code") %>"><h5 style="color:red">edit</h5></a>
							</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<div class="cell" data-title="Location">
								 <%-- <%=rs.getString("request") %> --%> 
								 <a href="delete.jsp?id=<%=rs.getString("id") %>"><h5 style="color:red">delete</h5></a>
							</div>
						</div>
