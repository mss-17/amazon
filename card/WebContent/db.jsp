	 ...
	 -->
		...
		<header id="header">
			...
			<h1 align="center"><font color="Dark Blue"><b>One India Card</b></font></h1>
				...
				<nav id="nav">
					...
					<div class="nav-drop">
						<ul>
					<li><a href="cr.jsp"><h4 style="color:yellow">Credit</h4></a></li>
					<li><a href="db.jsp"><h4 style="color:yellow">Debit</h4></a></li>
					<li><a href="user3.jsp"><h4 style="color:yellow"><h4 style="color:yellow">Logout</h4></a></li>
						</ul>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form  action="db1.jsp" class="login100-form validate-form">
					<span class="login100-form-title p-b-49">
						 Debit The Amount
					</span>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "card is reauired">
						<span class="label-input100"></span>
						<input class="input100" type="text" name="debit" placeholder="Enter The Amount">
